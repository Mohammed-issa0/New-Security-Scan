    ...
    <footer className="pt-20 pb-10 border-t border-gray-100 mt-20">
      <Container>
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h5 className="font-bold text-gray-900 mb-6 uppercase text-xs tracking-widest">{tf('productTitle')}</h5>
            <ul className="space-y-4 text-sm text-gray-500 font-medium">
              <li>
                <Link href="#features" className="hover:text-blue-600">{t('nav.features')}</Link>
              </li>
              <li>
          ...
          <div>
            <h5 className="font-bold text-gray-900 mb-6 uppercase text-xs tracking-widest">{tf('legalTitle')}</h5>
            <ul className="space-y-4 text-sm text-gray-500 font-medium">
              <li className="hover:text-blue-600 cursor-pointer">{tf('privacy')}</li>
              <li className="hover:text-blue-600 cursor-pointer">{tf('terms')}</li>
            </ul>
          </div>
        </div>
        
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-400">© 2025 {t('title')}. {tf('rights')}</p>
        </div>
      </Container>
    </footer>
  )
